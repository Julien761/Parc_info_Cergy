...
INSERT INTO TICKETS (ID, SUJET, DESCRIPTION, DATE_CREATION, PRIORITE, STATUS, UTILISATEUR_ID, TECHNICIEN_ID) VALUES (0, 'Problème de connexion', 'Impossible de se connecter à la base de données', (TO_DATE('2021/05/03 21:00:00', 'yyyy/mm/dd hh24:mi:ss')), 'Moyenne', 'En cours', 0, 3);
